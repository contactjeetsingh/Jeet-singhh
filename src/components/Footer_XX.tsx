        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-5">
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
              <li>
                <Link to="/salesforce-admin-training" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Admin Training
                </Link>
              </li>
              <li>
                <Link to="/salesforce-developer-training" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Developer Training
                </Link>
              </li>
              <li>
                <Link to="/salesforce-lightning-training" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Lightning Training
                </Link>
              </li>
              <li>
                <Link to="/salesforce-sales-cloud-training" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Sales Cloud Training
                </Link>
              </li>
              <li>
                <Link to="/salesforce-service-training" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Service Training
                </Link>
              </li>
              <li>
                <Link to="/salesforce-admin-developer-training" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Admin Developer Training
                </Link>
              </li>
              <li>
                <Link to="/salesforce-training-bangalore" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
                  Salesforce Training Bangalore
                </Link>
              </li>
              <li>
                <Link to="/salesforce-training-hyderabad" className="text-white/70 hover:text-white transition-colors inline-flex items-center">
                  <i className="fas fa-angle-right mr-2 text-sm"></i>
