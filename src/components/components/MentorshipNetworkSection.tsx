        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-gray-300">
              Want to be part of this constellation? <a href="/mentorship" className="text-blue-400 hover:text-blue-300 font-semibold underline decoration-dotted">Join the mentorship program →</a>
            </p>
          </div>
        </motion.div>
      </div>
