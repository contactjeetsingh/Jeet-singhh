        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">
              Salesforce product expertise across the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">entire lifecycle</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product, index) => {
            ...
            return (
              ...
              >
                ...
                <Link 
                  to={product.link}
                  className={`inline-flex items-center gap-1 text-sm font-medium ${product.textColor} group-hover:gap-2 transition-all`}
                >
                  Learn more
                ...
                {/* Decorative Dot */}
                <div className={`absolute inset-0 bg-gradient-to-br ${product.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500 pointer-events-none`}></div>
              </div>
            );
          })}

          {/* Special Card: End-to-End Integration */}
          <div className="lg:col-span-3 bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-2xl font-bold mb-2">Need the complete picture?</h3>
