...
import { 
  ...
  FileText, Award, Shield, Lock,
  Eye, Key, Fingerprint, FileCheck,
  ArrowRight
} from "lucide-react";
...
const SecurityChecklist = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Security Compliance Checklist Download',
          from_name: formData.name,
          email: formData.email,
          company: formData.company,
          role: formData.role,
          experience: formData.experience,
          resource: 'Security Compliance Checklist',
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          link.href = '/resources/security-checklist.xlsx';
          link.download = 'security-checklist.xlsx';
          link.click();
        }, 1000);
      }
    } catch (error) {
  ...
  const resourceDetails = {
    ...
    description: "HIPAA, GDPR, SOC2 readiness assessment. 50-point checklist to evaluate your Salesforce security posture and identify vulnerabilities.",
    format: "Excel + PDF",
    pages: 25,
    category: "Security",
    ...
    downloads: 2200,
    whatYouGet: [
      "50-point security assessment checklist",
      "HIPAA compliance tracking sheet",
      "GDPR readiness evaluation",
      "SOC2 control mapping",
      "Field-level security audit template",
            ...
            >
              ...
              <div className="bg-red-50 rounded-xl p-6 border border-red-100">
                ...
                <p className="text-sm text-gray-600">
                  Average cost of a data breach in 2024: $4.88M. This checklist helps you identify vulnerabilities before they become breaches. Used by 50+ enterprises to pass HIPAA, GDPR, and SOC2 audits.
                </p>
              </div>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="cso">CISO/Security Lead</option>
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
