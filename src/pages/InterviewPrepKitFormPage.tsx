...
import { 
  ...
  FileText, Award, MessageCircle, HelpCircle,
  Target, Zap, BookOpen, Briefcase,
  ArrowRight
} from "lucide-react";
...
const InterviewPrepKit = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Interview Preparation Kit Download',
          from_name: formData.name,
          email: formData.email,
          company: formData.company,
          role: formData.role,
          experience: formData.experience,
          resource: 'Interview Preparation Kit',
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          link.href = '/resources/interview-prep-kit.pdf';
          link.download = 'interview-prep-kit.pdf';
          link.click();
        }, 1000);
      }
    } catch (error) {
  ...
  const resourceDetails = {
    ...
    description: "Common questions and answers for Solution Architect and Technical Architect roles. Includes scenario-based questions, design problems, and whiteboarding exercises.",
    format: "PDF",
    pages: 80,
    category: "Career",
    ...
    whatYouGet: [
      ...
      "Solution architect scenario questions",
      "Technical architect deep-dives",
      "Whiteboarding exercise templates",
      "Design problem frameworks",
      "Answers and scoring rubrics",
      "Mock interview scripts"
    ],
    tableOfContents: [
      "Chapter 1: Interview Preparation Strategy",
      "Chapter 2: Common Questions by Role",
      "Chapter 3: Scenario-Based Questions",
      "Chapter 4: Design Problems",
      "Chapter 5: Whiteboarding Exercises",
      "Chapter 6: Technical Deep-Dives",
      "Chapter 7: Behavioral Questions",
      "Chapter 8: Questions to Ask Interviewers",
      "Chapter 9: Post-Interview Follow-up"
    ]
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-100">
                <h3 className="font-bold text-gray-900 mb-2">Sample Question</h3>
                <p className="text-sm text-gray-700 italic mb-2">
                  "Design a multi-org Salesforce strategy for a global company that just acquired 3 regional businesses. Walk me through your approach to consolidation."
                </p>
                <p className="text-xs text-gray-500">
                  Full answer framework and scoring rubric included in the guide.
                </p>
              </div>
            </motion.div>
            ...
            >
              {!isSubmitted ? (
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 sticky top-24">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Get Your Free Prep Kit</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-yellow-500"
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-500 hover:to-amber-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    <button 
                      ...
                      className="text-yellow-600 hover:text-yellow-700 font-medium mx-1"
                    >
                      click here
                    </button>
                  </p>
