...
const CTAStudyGuide = () => {
  ...
  const resourceDetails = {
    ...
    downloads: 2500,
    whatYouGet: [
      "In-depth coverage of all 8 architecture domains",
      "Sample review board questions and answers",
      "Architecture diagrams and decision trees",
      "Real-world case studies",
      "Study checklist and timeline",
      "Tips from successful CTA candidates"
    ],
    tableOfContents: [
      "Domain 1: Application Architecture",
      "Domain 2: Integration Architecture",
      "Domain 3: Data Architecture",
      "Domain 4: Security Architecture",
      "Domain 5: Identity & Access Management",
      "Domain 6: Development Lifecycle & Deployment",
      "Domain 7: Performance & Scalability",
      "Domain 8: Architecture Strategy & Governance"
    ]
  };
            ...
            >
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-100">
                ...
                <p className="text-sm text-gray-600">
                  Jeet Singh is a Salesforce Certified Technical Architect (CTA) with 15+ years of enterprise experience. He has mentored 50+ architects and helped 15+ candidates successfully pass the CTA review board.
                </p>
              </div>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="cta-candidate">CTA Candidate</option>
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
