...
import { 
  ...
  FileText, Award, Layers, GitBranch,
  Database, Shield, Zap, BarChart,
  ArrowRight
} from "lucide-react";
...
const ArchitectureChecklist = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Architecture Assessment Checklist Download',
          from_name: formData.name,
          email: formData.email,
          company: formData.company,
          role: formData.role,
          experience: formData.experience,
          resource: 'Architecture Assessment Checklist',
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          link.href = '/resources/architecture-checklist.xlsx';
          link.download = 'architecture-checklist.xlsx';
          link.click();
        }, 1000);
      }
    } catch (error) {
  ...
  const resourceDetails = {
    ...
    description: "50-point org health evaluation. Assess technical debt, performance, scalability, and governance across your Salesforce implementation.",
    format: "Excel",
    pages: 15,
    ...
    downloads: 1900,
    whatYouGet: [
      "50-point architecture assessment framework",
    ...
    tableOfContents: [
      ...
      "Section 7: Governance & Operations",
      "Section 8: Technical Debt Assessment",
      "Appendix: Scoring & Recommendations"
    ]
  };
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-2">
                ...
                <span>{resourceDetails.format} • {resourceDetails.pages} sheets</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
                <h3 className="font-bold text-gray-900 mb-2">Who Should Use This</h3>
                <p className="text-sm text-gray-600">
                  Solution Architects, Technical Architects, and CTOs preparing for org reviews, technical debt assessments, or CTA review board preparation.
                </p>
              </div>
            </motion.div>
            ...
            >
              {!isSubmitted ? (
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 sticky top-24">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Get Your Free Checklist</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    <button 
                      ...
                      className="text-indigo-600 hover:text-indigo-700 font-medium mx-1"
                    >
                      click here
                    </button>
                  </p>
