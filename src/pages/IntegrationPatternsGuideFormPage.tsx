...
import { 
  ...
  FileText, Award, GitBranch, Network,
  Zap, Repeat, Globe, Shield,
  ArrowRight
} from "lucide-react";

const IntegrationPatternsGuide = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Integration Patterns Guide Download',
          from_name: formData.name,
          email: formData.email,
          company: formData.company,
          role: formData.role,
          experience: formData.experience,
          resource: 'Integration Patterns Reference',
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          link.href = '/resources/integration-patterns-guide.pdf';
          link.download = 'integration-patterns-guide.pdf';
          link.click();
        }, 1000);
      }
    } catch (error) {
  ...
  const resourceDetails = {
    ...
    description: "Comparison matrix and implementation guides for real-time, batch, and event-driven integrations. Includes MuleSoft, Platform Events, and API patterns.",
    format: "PDF + Diagrams",
    pages: 75,
    category: "Technical",
    ...
    whatYouGet: [
      ...
      "Real-time API implementation guide",
    ...
    tableOfContents: [
      "Chapter 1: Integration Landscape Overview",
      "Chapter 2: Choosing the Right Pattern",
      "Chapter 3: Real-time API Patterns",
      "Chapter 4: Batch Integration Patterns",
      "Chapter 5: Event-Driven Architecture",
      "Chapter 6: Middleware Patterns (MuleSoft)",
      "Chapter 7: Error Handling & Retry Strategies",
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-amber-50 rounded-xl p-6 border border-amber-100">
                <h3 className="font-bold text-gray-900 mb-2">Pattern Decision Matrix</h3>
                <p className="text-sm text-gray-600">
                  Includes a comprehensive decision matrix to help you choose between real-time, batch, and event-driven patterns based on latency requirements, data volume, and complexity.
                </p>
              </div>
            </motion.div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 sticky top-24">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    <button 
                      ...
                      className="text-amber-600 hover:text-amber-700 font-medium mx-1"
                    >
                      click here
                    </button>
                  </p>
...
export default IntegrationPatternsGuide;