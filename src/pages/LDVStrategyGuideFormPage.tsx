...
import { 
  ...
  FileText, Award, Clock, BookOpen,
  Database, HardDrive, Gauge, Zap,
  Filter, Layers, Server,
  ArrowRight
} from "lucide-react";

const LDVStrategyGuide = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'LDV Strategy Guide Download',
          from_name: formData.name,
          email: formData.email,
          company: formData.company,
          role: formData.role,
          experience: formData.experience,
          resource: 'Large Data Volumes Strategy Guide',
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          link.href = '/resources/ldv-strategy-guide.pdf';
          link.download = 'ldv-strategy-guide.pdf';
          link.click();
        }, 1000);
      }
    } catch (error) {
  ...
  const resourceDetails = {
    ...
    description: "Best practices for handling 100M+ records in Salesforce. Big Objects, skinny tables, archiving strategies, and performance optimization.",
    ...
    downloads: 1800,
    whatYouGet: [
      "Complete LDV architecture framework",
      "Big Objects implementation guide with examples",
      "Skinny tables design patterns",
      "Data archiving strategy template",
      "Query optimization checklist",
      "Real-world case studies from 500M+ record orgs"
    ],
    tableOfContents: [
      "Chapter 1: Understanding Large Data Volumes",
      "Chapter 2: Data Modeling for Scale",
      "Chapter 3: Big Objects Deep Dive",
      "Chapter 4: Skinny Tables & Custom Indexing",
      "Chapter 5: Data Archiving Strategies",
      "Chapter 6: Query Optimization Techniques",
      "Chapter 7: Batch Processing at Scale",
      "Chapter 8: Monitoring & Performance Tuning",
      "Appendix: LDV Architecture Templates"
    ]
  };
 const relatedResources = [
{
title:"Apex Design Patterns Guide",
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                <h3 className="font-bold text-gray-900 mb-2">Who This Guide Is For</h3>
                <p className="text-sm text-gray-600">
                  Solution Architects, Technical Architects, and CTOs dealing with performance issues due to data volume. Perfect for organizations with 50M+ records facing governor limit challenges.
                </p>
              </div>
            </motion.div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="architect">Solution/Technical Architect</option>
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
...
export default LDVStrategyGuide;