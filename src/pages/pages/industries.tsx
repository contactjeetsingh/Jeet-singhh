                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1">
                          {industry.solutions.slice(0, 2).map((item, i) => (
                            <li key={i} className="text-xs text-gray-600 flex items-center gap-1">
                              <span className={`w-1 h-1 rounded-full bg-gradient-to-r ${industry.color}`}></span>
                              {item}
                            </li>
                    ...
                    <Link 
                      ...
                      className={`inline-flex items-center gap-1 text-sm font-medium ${industry.textColor} group-hover:gap-2 transition-all`}
                    >
                      Learn more
