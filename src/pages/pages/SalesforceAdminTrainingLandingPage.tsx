...
const SalesforceAdminTraining = () => {
  ...
  const courseHighlights = [
    {
      ...
      description: "20+ hours of comprehensive training"
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Complete Admin certification prep"
    },
    {
      icon: Laptop,
      title: "Hands-on Labs",
  ...
  const benefits = [
    {
      ...
      description: "Master real-world admin tasks used daily in enterprises"
    },
    {
      icon: TrendingUp,
      title: "Career Acceleration",
      description: "Average salary increase of 40% after certification"
    },
    {
      icon: Globe,
      title: "Global Recognition",
      description: "Salesforce certified skills recognized worldwide"
    },
    {
      icon: MessageCircle,
  ...
  const whatYouWillLearn = [
    "Set up and configure Salesforce org from scratch",
    "Manage users, profiles, permissions, and security",
    "Create custom objects, fields, and relationships",
    "Build powerful automation with Flow and Process Builder",
    "Design interactive reports and dashboards",
    "Implement data validation and business rules",
    "Master data management and import/export",
    "Prepare for Salesforce Admin Certification (ADM-201)"
  ];

  const testimonials = [
    {
      name: "Priya Sharma",
      role: "Salesforce Admin at Deloitte",
      image: "PS",
      quote: "Jeet's training transformed my career. I went from zero Salesforce knowledge to certified admin in 8 weeks. The live sessions were incredibly valuable.",
      rating: 5,
      outcome: "Placed within 3 months"
    },
    {
      name: "Rahul Verma",
      role: "Lead Admin at TCS",
      image: "RV",
      quote: "The hands-on labs and real-world scenarios made all the difference. I still refer to the course materials in my daily work.",
      rating: 5,
  ...
  const faqs = [
    {
      ...
      a: "Absolutely! The course starts from fundamentals and gradually builds up to advanced concepts. No prior Salesforce experience needed."
    },
    {
      q: "What's the difference between live and recorded?",
      a: "Live cohort includes real-time interaction with Jeet, Q&A sessions, and peer learning. Recorded gives you lifetime access to the same content at your own pace."
    },
    {
      q: "Will I get certification after completion?",
      a: "You'll receive a course completion certificate. The curriculum is designed to prepare you for the official Salesforce Admin Certification (ADM-201)."
    },
    {
      q: "What if I miss a live session?",
      a: "All live sessions are recorded and available in your dashboard. You can catch up anytime."
    }
  ];
    ...
    <Layout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 leading-tight">
                Become a Certified <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-300">Salesforce Admin</span>
              </h1>
              
              <p className="text-xl text-blue-100 mb-8">
                4-week live cohort or self-paced recorded training. Master Salesforce administration with hands-on labs and real-world projects.
              </p>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <span className="text-sm text-gray-500 line-through">₹24,999</span>
                    <div className="text-3xl font-bold text-gray-900">₹9,900</div>
                  </div>
                </div>

                <div className="flex items-center gap-2 mb-4">
                  <span className="bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded-full">Limited seats</span>
                  <span className="bg-purple-100 text-purple-700 text-xs font-semibold px-2 py-1 rounded-full">Starts May 15</span>
                </div>
                ...
                {selectedTab === 'recorded' && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <a
                        href="https://udemy.com/course/salesforce-admin"
                        target="_blank"
        ...
        <div className="container-wide">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">
              What You'll <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Learn</span>
            </h2>
            <p className="text-gray-600 text-lg">
              Comprehensive curriculum designed to make you job-ready
            </p>
          </div>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-16">
        <div className="container-wide">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">
              Course <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Curriculum</span>
            </h2>
            <p className="text-gray-600 text-lg">
              4 weeks • 20+ hours of comprehensive training
            </p>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="container-wide">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">
              Why Learn with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Jeet Singh</span>
            </h2>
            <p className="text-gray-600 text-lg">
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-16">
        <div className="container-wide">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-4">
              Student <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Success Stories</span>
            </h2>
            <p className="text-gray-600 text-lg">
        ...
        <div className="container-wide text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join 500+ successful students who've transformed their careers
            </p>
...
export default SalesforceAdminTraining;