...
import { 
  ...
  FileText, Award, Code, Layers,
  Braces, GitBranch, Box, Shield,
  ArrowRight
} from "lucide-react";

const ApexPatternsGuide = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Apex Design Patterns Guide Download',
          from_name: formData.name,
          email: formData.email,
          company: formData.company,
          role: formData.role,
          experience: formData.experience,
          resource: 'Apex Design Patterns Guide',
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          link.href = '/resources/apex-patterns-guide.pdf';
          link.download = 'apex-patterns-guide.pdf';
          link.click();
        }, 1000);
      }
    } catch (error) {
  ...
  const resourceDetails = {
    ...
    description: "Complete reference with code examples for Domain, Selector, Service, and Trigger patterns. Write maintainable, testable Apex code.",
    format: "PDF + Code",
    pages: 98,
    ...
    downloads: 2100,
    whatYouGet: [
      "Full code examples for all major patterns",
      "Domain layer implementation guide",
      "Selector layer with query optimization",
      "Service layer for complex orchestration",
      "Trigger handler framework",
      "Unit test patterns and factories",
      "Real-world refactoring examples"
    ],
    tableOfContents: [
      "Chapter 1: Why Design Patterns Matter",
      "Chapter 2: Domain Layer Pattern",
      "Chapter 3: Selector Layer Pattern",
      "Chapter 4: Service Layer Pattern",
      "Chapter 5: Trigger Handler Framework",
      "Chapter 6: Unit Testing Patterns",
      "Chapter 7: Factory and Utility Patterns",
      "Chapter 8: Refactoring Legacy Code",
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-100">
                <h3 className="font-bold text-gray-900 mb-2">Sample Code</h3>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200 sticky top-24">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full px-6 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-medium rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
...
export default ApexPatternsGuide;